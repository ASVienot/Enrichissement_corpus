...
"""
Ce programme permet d'entrainer un modèle Naive Bayes sur notre corpus réduit (A_1000.py).
"""

# COMMANDE LES AMIS : python3 nv_reduction.py
...
def obtention_phrases(test_evaluation, test_corpus):
    ...
    with open("data_resultats/data_prediction_nv_reduction.csv", "w") as fichier:
