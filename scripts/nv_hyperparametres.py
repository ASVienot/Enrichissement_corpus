...
"""
Ce programme permet d'entrainer un modèle Naive Bayes avec des hyperparamètres modifiés sur notre corpus d'origine et complet (totaldonnees.py) mais peut être aussi utilisé avec les corpus modifiés (corpus_annote.csv et A_1000.csv).
"""

# commande : python3 nv_hyperparametres.py
