...
"""
Ce programme permet d'entrainer un modèle Naive Bayes sur notre corpus d'origine et complet (totaldonnees.py) mais peut être aussi utilisé avec les corpus modifiés (corpus_annote.csv et A_1000.csv).
"""
