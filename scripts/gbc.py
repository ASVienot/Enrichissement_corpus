...
"""
Ce programme permet d'entrainer un modèle GBC sur notre corpus d'origine et complet (totaldonnees.py) mais peut être aussi utilisé avec les corpus modifiés (corpus_annote.csv et A_1000.csv).
"""

# COMMANDE LES AMIS : python3 gbc.py
# tout simple
...
def entrainement():
    ...
    corpus_dataframe = pd.read_csv('../data/totaldonnees.csv', header=0, usecols=[3,4], names=['phrase','accord'])
