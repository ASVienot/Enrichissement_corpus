...
""" Ce programme permet d'obtenir les occurrences de mots et de n-grams les plus communs dans les classes VP, FP, VN et FN de chaque test par algorithme. 
Les graphiques correspondant sont obtenus à l'aide de ce programme et sont dans graphs."""
import pandas as pd
